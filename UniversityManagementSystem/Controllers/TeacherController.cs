...
namespace UniversityManagementSystem.Controllers
{
    public class TeacherController : Controller
    {
        ...
        public ActionResult Create([Bind(Include="TeacherId,Name,Address,Email,ContractNo,DesignationId,DepartmentId,CreditToBeTaken,RemainingCredit")] Teacher teacher)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include="TeacherId,Name,Address,Email,ContractNo,DesignationId,DepartmentId,CreditToBeTaken,RemainingCredit")] Teacher teacher)
        {
            if (ModelState.IsValid)
            {
